...
import project1Img from '../../assets/images/homyfood.jpg'; // Remplacez par le chemin de vos images
import project2Img from '../../assets/images/Portfolio-photographe.jpg';
import project3Img from '../../assets/images/KASA-logement.jpg';
import project4Img from '../../assets/images/ArgentBank.png';
import htmlLogo from '../../assets/logo/html5.jpg';
                    ...
                    {projects.map((project, index) => (
                        ...
                        >
                            ...
                            <div className="flex justify-between items-center mb-2">
                                ...
                                >
                                   <img src="https://img.icons8.com/ios-filled/50/000000/github.png" className='w-8 h-8 transaction hover:scale-110 duration-300'/>
                                </a>
                            </div>
                                ...
                                <div className="flex space-x-2 mt-2">
                                    ...
                                    {project.technologies.map((tech, techIndex) => (
                                        <img key={techIndex} src={tech} alt="Technology logo" className="w-6 h-6 rounded" />
                                    ))}
