...
const About = () => {
    return (
        <section id="about" className="pt-8 w-full flex flex-col  items-center">
            <motion.div
            ...
            >
                <div className="flex flex-col items-center">
                    ...
                    <h2 className="text-4xl mb-4 p-4 font-semibold text-center text-gray-800">À propos de moi</h2>
